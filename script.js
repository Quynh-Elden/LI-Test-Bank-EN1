...
let currentUserInfo = ""; // Giriş yapan kişinin bilgisini burada tutacağız
...
function checkLogin() {
    ...
    // BU BİLGİYİ HAFIZAYA ALIYORUZ (Log için lazım olacak)
...
// --- GÜNCELLENEN KISIM: LOGLU KOPYALAMA ---
function copyToClipboard(elementId) {
    // Kutudaki soruları al
    const content = document.getElementById(elementId).innerText;
    
    // Tarih ve Saati al
    const now = new Date();
    const timeString = now.toLocaleString('en-GB'); // Gün/Ay/Yıl Saat:Dakika formatı
    
    // Eğer kopyalanan şey CEVAP ANAHTARI ise, log ekleme (Sadece sorulara ekle)
    let finalClip = "";
    ...
    if (elementId === 'questions-box') {
        ...
        // Cevap anahtarıysa direkt kopyala
        finalClip = content;
    }
